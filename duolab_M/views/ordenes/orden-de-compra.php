		...
		<div class="container-fluid">
			<div style="max-width: 1140px; margin: 0 auto;">
				...
				<form id="FRM_INSERT_DETA_ORDCOMPRA" method="post"
					action="<?php echo $functions->direct_sistema(); ?>/modules/ordenes/insert-update-orden.php"
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Número OC"
													name="orden_nro" readonly>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-md-7">
											<div class="input-group">
												...
												<input type="number" step="0.01" min="0" class="form-control"
													placeholder="Venta" name="orden_tcventa">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-md-7">
											<div class="input-group">
												...
												<input type="number" step="0.01" min="0" class="form-control"
													placeholder="Compra" name="orden_tccompra">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="input-group mb-3">
											...
											<input type="date" name="orden_fecentrega" class="form-control"
												value="<?php echo date('Y-m-d'); ?>" required>
										</div>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div class="input-group mb-3">
											...
											<input type="text" name="orden_cotizacion" class="form-control"
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="orden_nrocuenta" placeholder="Número de cuenta"
											class="form-control">
									</div>
								</div>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Glosa</label>
												<input type="text" name="orden_glosa" placeholder="Glosa"
													class="form-control">
											</div>
										</div>
									</div>
									...
									<div class="mt-3">
										<button id="btn-add-prodtporden" class="btn btn-primary btn-block"><i
					...
					<div class="row mt-3 mb-3">
						<div id="col-btn-save-orden" class="col-md-12">
							<button type="submit" id="btn-save-orden" class="btn btn-success btn-block"><i
									class="fa fa-save fa-1x"></i>&nbsp;&nbsp;<font>Registrar Orden</font></button>
						</div>
						<div id="col-btn-delete-orden" class="col-md-6">
							<button type="button" id="btn-delete-orden" class="btn btn-danger btn-block"><i
									class="fa fa-trash fa-1x"></i>&nbsp;&nbsp;<font>Eliminar Orden</font></button>
						</div>
					</div>
				</form>
			</div>
